...
const clients = [
  { id: 'c01', code: 'C001', name: '緑ヶ丘ハウジング株式会社', industry: '不動産・住宅', contact_person: '田中 一郎', address: '東京都世田谷区緑ヶ丘1-2-3', contract_start_date: '2018-04-01', phone: '03-1111-2222' },
  { id: 'c02', code: 'C002', name: '株式会社サンパーク管理', industry: '不動産管理', contact_person: '佐藤 花子', address: '東京都杉並区高井戸2-4-6', contract_start_date: '2019-07-15', phone: '03-2222-3333' },
  { id: 'c03', code: 'C003', name: '市川市 公園緑地課', industry: '官公庁', contact_person: '鈴木 健', address: '千葉県市川市八幡1-1-1', contract_start_date: '2015-04-01', phone: '047-333-4444' },
  { id: 'c04', code: 'C004', name: '医療法人社団 若葉会', industry: '医療・福祉', contact_person: '高橋 美咲', address: '東京都練馬区若葉台3-5-7', contract_start_date: '2020-10-01', phone: '03-4444-5555' },
  { id: 'c05', code: 'C005', name: '株式会社フォレストリテール', industry: '商業施設', contact_person: '伊藤 大輔', address: '神奈川県横浜市港北区新横浜4-8-2', contract_start_date: '2021-03-01', phone: '045-555-6666' },
  { id: 'c06', code: 'C006', name: 'learning学園 常盤台学院', industry: '教育', contact_person: '渡辺 直樹', address: '東京都板橋区常盤台2-9-1', contract_start_date: '2017-04-01', phone: '03-6666-7777' },
  { id: 'c07', code: 'C007', name: '株式会社グリーンテラス開発', industry: 'デベロッパー', contact_person: '山本 恵美', address: '東京都港区南青山3-11-5', contract_start_date: '2022-06-01', phone: '03-7777-8888' },
  { id: 'c08', code: 'C008', name: '社会福祉法人 陽だまり会', industry: '医療・福祉', contact_person: '中村 悠斗', address: '埼玉県さいたま市浦和区常盤6-2-3', contract_start_date: '2016-09-01', phone: '048-888-9999' },
  { id: 'c09', code: 'C009', name: '株式会社ヒルトップリゾート', industry: 'ホテル・観光', contact_person: '小林 亮', address: '静岡県熱海市渚町1-4', contract_start_date: '2019-01-15', phone: '0557-9-0000' },
  { id: 'c10', code: 'C010', name: '株式会社セントラルロジスティクス', industry: '物流', contact_person: '加藤 沙織', address: '千葉県船橋市葛飾町2-1-1', contract_start_date: '2023-04-01', phone: '047-0-1111' },
]
