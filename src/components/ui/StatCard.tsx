...
export function StatCard({ label, value, icon, hint, masked }: StatCardProps) {
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-brand-100 bg-white p-4 shadow-sm sm:p-5">
      {icon && (
      ...
      <div className="min-w-0 flex-1">
        ...
        {masked ? (
          ...
          <>
            <p className="mt-1 text-xl font-bold text-brand-800 sm:text-2xl">{value}</p>
