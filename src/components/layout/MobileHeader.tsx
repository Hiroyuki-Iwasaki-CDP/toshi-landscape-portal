    ...
    <div className="md:hidden">
      ...
      {open && (
        <div className="fixed inset-0 z-40 flex">
          ...
          <div className="relative flex w-[85%] max-w-sm flex-col overflow-y-auto bg-white shadow-xl">
            <div className="flex items-center justify-between border-b border-brand-100 px-4 py-4">
              ...
              <button
                ...
                className="rounded-lg p-2 text-gray-500 hover:bg-brand-50"
              >
                <X className="h-6 w-6" />
              </button>
            </div>
            ...
            <div className="border-t border-brand-100 px-4 py-3">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-50 px-4 py-2.5 text-sm font-semibold text-brand-700"
              >
